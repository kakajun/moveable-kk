<template>
  <div class="lc-hotkey-des" style="color: white">
      <div v-for="(item, index) in hotkeys" :key="index" class="hotkey-des-item">
          <div class="hotkey-content"><code>{{ item.key }}</code></div>
          <div class="hotkey-des">{{ item.name }}</div>
      </div>
  </div>
</template>
