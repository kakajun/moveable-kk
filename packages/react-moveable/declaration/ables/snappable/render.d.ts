...
export declare function renderDigitLine(moveable: MoveableManagerInterface<SnappableProps, SnappableState>, type: "vertical" | "horizontal", lineType: "dashed" | "gap", index: number, gap: number, renderPos: number[], className: string | undefined, React: Renderer, middlePosition?: number, singleGap?: number): any;
